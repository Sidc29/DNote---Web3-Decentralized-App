...
import { idlFactory } from './notekeeper_frontend.did.js';
export { idlFactory } from './notekeeper_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NOTEKEEPER_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./notekeeper_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the notekeeper_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./notekeeper_frontend.did.js")._SERVICE>}
 */
export const notekeeper_frontend = createActor(canisterId);
