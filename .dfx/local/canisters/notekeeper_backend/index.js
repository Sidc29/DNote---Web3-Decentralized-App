...
import { idlFactory } from './notekeeper_backend.did.js';
export { idlFactory } from './notekeeper_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.NOTEKEEPER_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./notekeeper_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the notekeeper_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./notekeeper_backend.did.js")._SERVICE>}
 */
export const notekeeper_backend = createActor(canisterId);
